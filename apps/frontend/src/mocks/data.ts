...
export const courses: Course[] = [
  {
    ...
    slug: "fundamentos-de-web-moderna",
    title: "Fundamentos de Web Moderna",
    summary: "Do HTTP ao deploy: como uma aplicação web nasce, roda e chega ao usuário.",
    artwork: 0,
    modules: [
      {
        id: "c1-m1",
        title: "Como a web funciona",
        lessons: lessons("c1m1", ["Cliente, servidor e HTTP", "DNS e TLS na prática", "Cache e CDN", "Ferramentas do navegador"], 28),
      },
      {
        id: "c1-m2",
        title: "HTML e CSS que sustentam",
        lessons: lessons("c1m2", ["Semântica e acessibilidade", "Layout com Flexbox", "Layout com Grid", "Design responsivo", "Variáveis e temas"], 30),
      },
      {
        id: "c1-m3",
        title: "JavaScript no navegador",
        lessons: lessons("c1m3", ["Tipos e escopo", "Assíncrono e Promises", "Manipulação do DOM", "Eventos e delegação", "Erros comuns"], 26),
      },
      {
        id: "c1-m4",
        title: "Do código ao ar",
        lessons: lessons("c1m4", ["Build e bundlers", "Variáveis de ambiente", "Deploy contínuo", "Medindo performance"], 32),
      },
    ],
  },
  {
    ...
    summary: "Tipos que pegam defeito antes do usuário, sem transformar o código num quebra-cabeça.",
    artwork: 1,
    modules: [
      {
        id: "c2-m1",
        title: "O sistema de tipos",
        lessons: lessons("c2m1", ["Inferência e anotação", "União e interseção", "Narrowing", "Generics sem medo"], 24),
      },
      {
        id: "c2-m2",
        title: "Modelando o domínio",
        lessons: lessons("c2m2", ["Tipos que impedem estado inválido", "Discriminated unions", "Utility types", "Quando `any` é aceitável"], 27),
      },
      {
        id: "c2-m3",
        title: "No projeto real",
        lessons: lessons("c2m3", ["Configurando o tsconfig", "Tipando uma API", "Migrando JavaScript existente", "Erros que o compilador não pega"], 26),
      },
    ],
  },
  {
    ...
    status: "published",
    enrollmentMode: "assigned",
    slug: "seguranca-para-quem-desenvolve",
    title: "Segurança para Quem Desenvolve",
    summary: "As falhas que aparecem em auditoria, explicadas do lado de quem escreve o código.",
    artwork: 2,
    modules: [
      {
        id: "c3-m1",
        title: "O básico que falha",
        lessons: lessons("c3m1", ["Injeção de SQL", "XSS e sanitização", "CSRF e SameSite", "Cabeçalhos de segurança"], 22),
      },
      {
        id: "c3-m2",
        title: "Identidade e sessão",
        lessons: lessons("c3m2", ["Senha, hash e salt", "Sessão versus token", "OAuth e OIDC", "Multifator", "Recuperação de conta"], 30),
      },
      {
        id: "c3-m3",
        title: "Segredo e dado",
        lessons: lessons("c3m3", ["Segredo fora do código", "Cifra em repouso", "LGPD para desenvolvedor", "Log sem vazar dado", "Dependência vulnerável"], 34),
      },
      {
        id: "c3-m4",
        title: "Antes de publicar",
        lessons: lessons("c3m4", ["Revisão com foco em risco", "Varredura automatizada", "Modelagem de ameaça", "Resposta a incidente", "Post-mortem sem culpado", "Divulgação responsável"], 28),
      },
    ],
  },
  {
    ...
    status: "published",
    enrollmentMode: "open",
    slug: "comunicacao-tecnica",
    title: "Comunicação Técnica",
    summary: "Escrever e falar de forma que quem lê decide — em PR, incidente e proposta.",
    artwork: 3,
    modules: [
      {
        id: "c4-m1",
        title: "Escrita que resolve",
        lessons: lessons("c4m1", ["Escrever para quem decide", "A mensagem de commit", "Documentação que envelhece bem", "Registro de decisão", "Resumo executivo"], 20),
      },
      {
        id: "c4-m2",
        title: "Revisão de código",
        lessons: lessons("c4m2", ["Revisar sem travar o time", "Receber crítica", "Discordar com dado", "Quando aprovar mesmo assim"], 24),
      },
      {
        id: "c4-m3",
        title: "Falar em público",
        lessons: lessons("c4m3", ["Apresentar arquitetura", "Comunicar incidente", "Estimar sem chutar", "Dizer não com alternativa", "Reunião que termina em decisão"], 22),
      },
    ],
  },
];
...
export const materials: Record<string, LessonMaterial[]> = {
  "c1m3-l5": [
    { id: "m1", name: "Checklist de revisão de código", kind: "pdf", sizeLabel: "480 kB" },
    { id: "m2", name: "Planilha de orçamento de performance", kind: "spreadsheet", sizeLabel: "62 kB" },
    { id: "m3", name: "Guia de acessibilidade do time", kind: "pdf", sizeLabel: "1,2 MB" },
  ],
};
...
export const comments: Comment[] = [
  {
    ...
    body: "No projeto onde trabalho o bundle passou de 400 kB depois de uma dependência nova. Dá para descobrir o que entrou sem refazer o build inteiro?",
  ...
  },
  {
    ...
    body: "Boa pergunta, João. Roda o analisador de bundle antes de mexer em qualquer coisa: ele mostra o peso por módulo e quase sempre o culpado é uma biblioteca que entrou inteira quando só se usava uma função dela. Se for o caso, importe direto do submódulo ou troque por algo menor — refazer o build às cegas costuma custar mais que medir.",
  ...
  },
  {
    ...
    authorId: "u1",
    authorName: "Aluno",
    body: "O trecho sobre cache de CDN esclareceu uma dúvida que eu tinha há tempos. Vale rever a partir dos 12 minutos.",
  ...
  },
  {
    ...
    body: "Uma dica prática: meça o tempo de build antes e depois de cada dependência nova. Em duas semanas você já enxerga qual delas está custando caro, sem precisar de ferramenta nenhuma.",
  ...
  },
  {
    ...
    authorId: "s4",
    authorName: "Priscila Alves",
    body: "Fiquei na dúvida entre XSS refletido e armazenado no exemplo do minuto 9. Comentário que o servidor devolve na mesma resposta entra em qual dos dois?",
...
export const catalogOnly: Course[] = [
  {
    ...
    status: "published",
    enrollmentMode: "open",
    slug: "git-e-fluxo-de-trabalho",
    title: "Git e Fluxo de Trabalho",
    summary: "Histórico legível, merge sem drama e o que fazer quando algo dá errado.",
    artwork: 1,
    modules: [
      {
        id: "c5-m1",
        title: "O modelo do Git",
        lessons: lessons("c5m1", ["Commit, árvore e blob", "Branch e merge", "Rebase e quando usar"], 26),
      },
      {
        id: "c5-m2",
        title: "Trabalho em equipe",
        lessons: lessons("c5m2", ["Pull request útil", "Resolvendo conflito", "Desfazendo sem perder trabalho"], 30),
      },
    ],
  },
  {
    ...
    summary: "Modelagem, índice e transação: por que a consulta ficou lenta e como descobrir.",
    artwork: 2,
    modules: [
      {
        id: "c6-m1",
        title: "Modelagem",
        lessons: lessons("c6m1", ["Normalização na medida", "Chave e integridade", "Índice: quando ajuda", "Lendo o plano de execução"], 24),
      },
      {
        id: "c6-m2",
        title: "Operação",
        lessons: lessons("c6m2", ["Transação e isolamento", "Migração sem downtime", "Backup que restaura", "Monitorando o banco"], 32),
      },
    ],
  },
  {
    ...
    summary: "WCAG traduzida em decisão de código: contraste, foco, teclado e leitor de tela.",
    artwork: 3,
    modules: [
      {
        id: "c7-m1",
        title: "O que a norma pede",
        lessons: lessons("c7m1", ["Contraste e cor", "Navegação por teclado", "Foco visível"], 22),
      },
      {
        id: "c7-m2",
        title: "Na prática",
        lessons: lessons("c7m2", ["HTML semântico primeiro", "ARIA sem exagero", "Testando com leitor de tela"], 25),
      },
    ],
  },
];
...
export const tracks: Track[] = [
  {
    ...
    summary: "Do primeiro request ao deploy: a formação completa de quem constrói para a web.",
    courseIds: ["c1", "c2", "c6"],
    mode: "sequential",
  },
  {
    id: "t2",
    slug: "praticas-de-time",
    title: "Práticas de Time",
    summary: "O que faz um time entregar junto: comunicação, revisão e acessibilidade como padrão.",
    courseIds: ["c4", "c7"],
    mode: "free",
  },
];
...
export const events: CalendarEvent[] = [
  ...
  { id: "e5", date: noMesAtual(4), title: "Prazo: Comunicação Técnica", kind: "deadline" },
...
export const auditEvents: AuditEvent[] = [
  ...
  { id: "a2", at: "2026-08-12T09:02:00-03:00", actorId: "u2", actorName: "Instrutor", action: "course_published", target: "Fundamentos de Web Moderna", outcome: "allowed", ip: "200.150.10.8" },
